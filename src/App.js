    ...
    <div className="relative flex min-h-screen ">
      ...
      {/* className="shadow" */}
        ...
        <div className="p-8  items-center ">
          ...
          <a href="" className="flex items-center py-3 px-4 space-x-2 hover:bg-[#dadadc] rounded-lg text-sm hover:text-black font-bold">
          ...
          <a href="" className="flex items-center py-3 px-4 space-x-2">
            ...
            <span className="text-sm text-black font-bold">Coffee?</span>
          </a> 
